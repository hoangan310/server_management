...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable class="border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 lg:dark:bg-zinc-900/50">
        ...
        <flux:navlist variant="outline">
            ...
            {{-- </flux:navlist.group>--}}
            @canany(['view users', 'view roles', 'view permissions', 'view servers'])
            <flux:navlist.group heading="Users" class="grid">
                ...
                @can('view servers')
                <flux:navlist.item icon="server" :href="route('admin.servers.index')" :current="request()->routeIs('admin.servers.*')">
                    {{ __('servers.title') }}
                </flux:navlist.item>
                @endcan
            </flux:navlist.group>
